% Tra�a Fluxaao de Pot�ncia Aparente Fase A
...
if (selecao*tem_corrente')>=1 % verifica se os terminais selecionados possuem corrente
    ...
    title(strcat('Fluxaao de Pot�ncia Aparente Fase A [',num2str(taxa_amostras),'f/s]'));
...
auto_format_time_axis();
    ...
    sinal_nome = ('Fluxaao de Pot�ncia Aparente Fase A');
